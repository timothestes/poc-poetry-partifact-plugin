...
from poc_poetry_partifact_plugin.partifact.auth_token import get_token
from poc_poetry_partifact_plugin.partifact.config import Configuration
from poc_poetry_partifact_plugin.partifact.shell_commands import (
    configure_pip,
    configure_poetry,
)
...
role_option = typer.Option(None, help="The AWS role to use when getting the CodeArtifact token.")
