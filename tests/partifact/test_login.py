...
from poc_poetry_partifact_plugin.partifact.config import Configuration
from poc_poetry_partifact_plugin.partifact.main import app
...
def load_config_mock(mocker) -> Mock:
    ...
    load_mock = mocker.patch("poc_poetry_partifact_plugin.partifact.main.Configuration.load")
...
def token_mock(mocker):
    ...
    mock = mocker.patch("poc_poetry_partifact_plugin.partifact.main.get_token")
...
def test_login_generates_token_with_correct_inputs(load_config_mock: Mock, token_mock: Mock):
